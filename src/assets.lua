...
assets.snd_catjump = love.audio.newSource("assets/catjump.wav", "static")
assets.snd_cannon = love.audio.newSource("assets/cannon.wav", "static")
assets.snd_thud = love.audio.newSource("assets/thud.wav", "static")
assets.snd_meow = love.audio.newSource("assets/meow.ogg", "static")
assets.snd_oink = love.audio.newSource("assets/oink.ogg", "static")
assets.snd_yay = love.audio.newSource("assets/yay.wav", "static")
